    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            with th.no_grad():
                ...
                extend_state_tensor = th.as_tensor(self._last_extend_state, device=self.device)
                actions, values, log_probs = self.policy(obs_tensor, extend_state_tensor)
            ...
            for idx, done in enumerate(dones):
                if (
                    ...
                    terminal_extend_state = self._last_extend_state[idx]
                    with th.no_grad():
            ...
            self._last_extend_state = new_extend_state
