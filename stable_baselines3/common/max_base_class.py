...
from stable_baselines3.common.max_policies import BasePolicy
...
class BaseAlgorithm(ABC):
    ...
    def __init__(
        ...
        self._last_extend_state = None  # type: Optional[Union[np.ndarray, dict[str, np.ndarray]]]
    ...
    def _setup_learn(
        ...
        if reset_num_timesteps or self._last_obs is None:
            ...
            self._last_extend_state = np.zeros((self.env.num_envs,), dtype=np.float32)
    ...
    def predict(
        ...
        """
        return self.policy.predict(observation, extend_state, state, episode_start, deterministic)
